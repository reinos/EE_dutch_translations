...
'form:docs'       =>	'Documentatie',
'form:yes'        =>	'Ja',
'form:no'         =>	'Ne',
'form:none'       =>	'None',
'form:save'       =>	'Opslaan',
'form:unknown'    =>	'Onbekend',
'form:actions'    =>	'Acties',
'form:loading'	  =>	'Data laden, even geduld alstublieft',
'form:desc'       =>	'Omschrijving',
...
'form:order_by' =>  'Volgorde',
'form:sort' =>  'Sortering',
'form:asc'  =>  'ASC',
'form:desc' =>  'DESC',
'form:entry_date'=> 'Entry datum',
'form:show_expired' => 'Show Expired',
'form:show_future' => 'Show Future',
...
'form:tmpl_predefined'	=>	'Predefined Templates',
...
'form:success_msg_when'        =>	'Confirm Message Behavior',
...
'f:encryption_status'=> 'Encryption Status',
...
'f:sms' => 'SMS',
'f:sms:from' => 'From',
'f:sms:from:exp' => 'Approved number (int. format) or Short Code<br>Tip: Nexmo allows for custom Sender ID for recipients outside of the U.S./Canada',
'f:sms:to' => 'To',
'f:sms:to:exp' => 'International Format, separate multiple with a comma.',
'f:sms:body' => 'Body',
'f:sms:body:exp' => 'Max 144 chars',

//----------------------------------------
// Submission Errors
//----------------------------------------
'form:ident'	=>	'Identifier',
'form:system_messages'	=>	'Systeem berichten',
'form:message'	=>	'Bericht',
'form:error:missing_data'		=>	'Geen data',
'form:error:not_authorized'		=>	'Je bent niet geautoriseerd om deze actie uit te voeren.',
'form:error:captcha_required'	=>	'Je dient de woorden uit de afbeelding overnemen.',
'form:error:captcha_incorrect'	=>	'You did not submit the word exactly as it appears in the image',
'form:error:required_field'		=>	'Veld is verplicht',
'form:error:invalid_date'       =>  'Invalid date specified.',
'f:err:invalid_phone'   =>  'Invalid Phone Number (numbers only please)',
'f:err:dupe'   =>  'Another entry with the specified value already exists.',
...
'f:export_template' => 'Export Template',
...
'f:silent_subsribe' => 'Silent Subscribe',
'f:no_silent_sub'	=>	'No, Trigger Welcome/Change-of-interest emails',
...
'f:send_email_for_receipt' => 'Send email address (for receipts)',

'f:sms_prov'    =>  'SMS Providers',
...
'f:settings:email_lib'  =>  'Email Library',
...
'form:recaptcha2_error'  =>  'You must correctly complete the reCAPTCHA challenge.',
...
'form:help:discount' => 'Discounts may be applied via percentage (20%) or by any numerical value (20.00).',
'form:help:coupon_limit' => 'By entering an integer (full number) your coupon will be limited in use by that amount. 0 (zero) will disable the coupon. Any other character, including leaving it blank, will allow it to be unlimited.',
